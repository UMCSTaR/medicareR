...
## Datasets
Changes needed for professional claims. 

file location: the purchased procedures are located on Maize: `Shared3/DMH_Shared/Dimick_Improve_Surgical_Care/SAS_Files/New_Hernia_ECMD`

Note: in the data folder, you can find the datasets from 2007-2016. As mentioned above, after 2016, all procedures will be in one data file under yearly purchased, eg. Dimick_Improve_Surgical_Care/SAS_Files/2018.
...
- Combine new carrier files to the original 5 carrier files; 
    ...
    - Newly added procedures claims are saved under file George_Surgeon_Projects/original_medicare_selected_vars/data/Carrier/ecs
Combine ecs claim and line files with the original 5 procedures by year.
...
## Process
- Create a defined CPT to procedures names map. The map we use for the project is at [ecs_list](https://docs.google.com/spreadsheets/d/1Fa2xWCRIe5-_3F7MpQPvJfCzy_lBtWFvB_TGevnZ60Q/edit#gid=1841533335).
    - In the list, CPTs to ECS procedures are not uniquely mapped. Make sure to get unique maps between cpt to ECS to avoid data            processing errors (introduce by left join process)
...
- Coding steps
    - Create 0.1% sample data for the carrier claim and line files
        - To avoid overwriting the original 5 procedures data, a new folder “original_5” was created to store the old data.
        <img src="/Users/xilinchen/Documents/Repo/medicareR/vignettes/images/maize_folder_structure.png" align="center" /> 
    ...
    - Standardize the combined datasets using code std_master
      ...
      - In the standardization process, rerun code for step3: Professional and step5: Professional Claim using the combined carrier claim and line files. The script can be found on github.
      
- Run the (step2_generate_analytic_file)[https://github.com/UMCSTaR/Medicare_Std_R/blob/add_procedures/code/step2_generate_analytic_file/analytic_master.R] step.
